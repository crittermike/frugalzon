...
function frugalzon_preprocess_html(&$vars, $hook) {
...
function frugalzon_preprocess_block(&$vars, $hook) {
...
function frugalzon_preprocess_node(&$vars) {
 ...
 */	
function frugalzon_id_safe($string) {
 ...
 * 
 */
function frugalzon_menu_link(array $variables) {
  ...
  $element['#attributes']['class'][] = frugalzon_id_safe($element['#title']);
